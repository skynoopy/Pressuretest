...
from first_app import auth, forms, Home_page, blog
import configs
from first_app.exts import db
from flask_bootstrap import Bootstrap
from first_app.forms import LoginForm
from first_app.auth import login_required
from first_app.Restful import RestfulApi, User_permissions_api, AuthorityApi, Tree_api
...
def create_app(test_config=None):
    ...
    app.register_blueprint(Tree_api.account)
